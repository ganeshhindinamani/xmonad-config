...
myManageHook = composeAll . concat $
    ...
    myCFloats = ["arcolinux-logout.py","Arandr", "Arcolinux-calamares-tool.py", "Arcolinux-tweak-tool.py", "Arcolinux-welcome-app.py", "Galculator", "feh", "mpv", "Xfce4-terminal", "variety"]
...
myMouseBindings (XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    --, ((controlMask, 3), (\w -> focus w >> mouseResizeWindow w >> windows W.shiftMaster))
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  --, ((modMask .|. shiftMask , xK_k ), spawn $ "klavaro")
...
, layoutHook = gaps [(U,40), (D,5), (R,10), (L,10)] $ myLayout ||| layoutHook myBaseConfig
